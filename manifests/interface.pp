...
define network::interface (
  ...
  $physdev                                               = undef,
  $bridge                                                = undef,
  Optional[Stdlib::Yes_no] $arpcheck                     = undef,
  $zone                                                  = undef,
  Optional[Stdlib::Yes_no] $arp                          = undef,
  Optional[Stdlib::Yes_no] $nozeroconf                   = undef,
  $linkdelay                                             = undef,
  $check_link_down                                       = false,
  $hotplug                                               = undef,
  ...
  Optional[Pattern[/^(qeth|lcs|ctc)$/]] $nettype         = undef,
  Optional[Variant[Integer[0,1], Enum['0','1']]] $layer2 = undef,
  ...
  $aliases                                               = undef,
  $remote_ipaddr                                         = undef,
  Optional[Stdlib::Yes_no] $check_duplicate_ip           = undef,
  Optional[Stdlib::Yes_no] $send_gratuitous_arp          = undef,
  $pre_up_script                                         = undef,
  ...
  if $facts['os']['name'] == 'SLES' and $facts['os']['release']['major'] =~ /^12/ {
